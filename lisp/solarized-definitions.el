...
(defvar solarized-colors           ; ANSI(Solarized terminal)
  ...
  '((base03  "#002b36" "#042028" "#1c1c1c" "brightblack"   "black")
    (base02  "#053642" "#0a2832" "#262626" "black"         "black")
    (base01  "#576e75" "#465a61" "#585858" "brightgreen"   "green")
    (base00  "#647b83" "#52676f" "#626262" "brightyellow"  "yellow")
    (base0   "#839496" "#708183" "#808080" "brightblue"    "blue")
    (base1   "#93a1a1" "#81908f" "#8a8a8a" "brightcyan"    "cyan")
    (base2   "#eee8d4" "#eae3ca" "#e4e4e4" "white"         "white")
    (base3   "#fdf6e2" "#fcf4db" "#ffffd7" "brightwhite"   "white")
    (yellow  "#b68800" "#a57705" "#af8700" "yellow"        "yellow")
    (orange  "#cb4c12" "#bd3612" "#d75f00" "brightred"     "red")
    (red     "#de362f" "#c60007" "#d70000" "red"           "red")
    (magenta "#d53c84" "#c61b6e" "#af005f" "magenta"       "magenta")
    (violet  "#6c73c6" "#5859b7" "#5f5faf" "brightmagenta" "magenta")
    (blue    "#218cd4" "#2075c7" "#0087ff" "blue"          "blue")
    (cyan    "#22a098" "#259185" "#00afaf" "cyan"          "cyan")
    (green   "#849700" "#728a05" "#5f8700" "green"         "green"))
